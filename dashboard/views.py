...
from .view_modules.contratacion import contratacion_data, contratacion_sincronizar
...
from .view_modules.pages import crud_main_view, consultas_view, gerencial_view, home, proyecto_detalle_view
